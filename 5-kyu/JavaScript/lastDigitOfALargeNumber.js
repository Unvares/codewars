/*
  ...
  the last decimal digit of a^b. Note that aaa and bbb may be very large!
  ...
  is 6. Also, please take 0^0 to be 11.
...
var lastDigit = function(a, b) {  
  if(b == '0') return 1;
  const degree = BigInt(b) % 4n || 4n;
  return +(String(BigInt(a.slice(-1)) ** degree).slice(-1));
}